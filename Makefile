...
# translation
SOURCES = sogissuche.py ui_sogissuche.py __init__.py sogissuchedialog.py
#TRANSLATIONS = i18n/sogissuche_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = sogissuche

PY_FILES = sogissuche.py sogissuchedialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_sogissuche.py
